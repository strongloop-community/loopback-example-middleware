...
2. Set `app.get('remoting').errorHandler` to call a custom error handler. [See here](https://github.com/strongloop/loopback-faq-middleware/blob/master/server/server.js#L23-l31)) 
